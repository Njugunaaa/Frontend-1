...
export default function WhatWeDoFixed() {
  const activities = [
    {
      icon: Users,
      title: "Our Community",
    ...
    },
    {
      ...
      description: "We believe Jesus Christ is our Savior, Healer, Baptiser with the Holy Spirit, and Soon Coming King. Our mission is to glorify God through worship, service, and community building.",
      color: "text-orange-400"
    },
    {
      icon: BookOpen,
      title: "Our Programs",
      description: "We offer Vacation Bible School for children, live worship services, church conferences, and various fellowship events throughout the year to nurture faith and build community.",
      color: "text-orange-400"
    }
  ];
